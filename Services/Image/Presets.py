...
class Icons:
    ...
    TRASH = I("trash.svg")
    BELL = ThemedIconManager.create(_P(IconPath.LIGHT, "bell_light.svg"), _P(IconPath.DARK, "bell_dark.svg"))
    BELL_OFF = ThemedIconManager.create(_P(IconPath.LIGHT, "bell_off_light.svg"), _P(IconPath.DARK, "bell_off_dark.svg"))
    UPDATE_FOUND = I("update_found.svg")
    VERIFIED = I("verified.svg")
    VIEWER = I("viewer.svg")
    WARNING_RED = I("warning_red.svg")
    WEB = I("web.svg")
    FAVORITES = I("favorites.svg")